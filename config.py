...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6473604912:AAGZl7uipRHXeXNVrj6qOdMr37Cm3wPwAyQ")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001756359495"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "botblrabbitchbot")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002077977394"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "1948646244").split()):
        ADMINS.append(int(x))
except ValueError:
